...
- 输出 README 简报、Launch Kit、Star 增长计划、GitHub 仓库展示包、贡献者 issue 队列、GitHub issue、Show HN、X 线程、Reddit 帖子和 JSON 记录。
...
5. 为最强机会导出 Star 增长计划，按 1、10、100、1k、10k stars 分阶段执行。
6. 用 Launch Kit 准备 Hacker News、Product Hunt、Reddit 和开发者 newsletter 发布素材。
7. 写公开构建日志，说明如何在写代码前判断一个 AI 应用想法是否值得做。
8. 持续维护机会图库和 README 审计能力，让示例和工具本身一起带来 stars。
