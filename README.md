...
- Repo metadata apply: `GITHUB_TOKEN=github_pat_... pnpm repo:profile:apply` or `GH_TOKEN=github_pat_... pnpm repo:profile:apply` can sync the About description, homepage, issues setting, and topics before launch.
